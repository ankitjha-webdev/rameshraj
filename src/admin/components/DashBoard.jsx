            ...
            <ul>
              ...
              <li className="relative px-6 py-3">
                ...
                >
                  ...
                  <span className="ml-4">Add Post</span>
                </a>
              </li>
              <li className="relative px-6 py-3">
                <a
                ...
                >
                  ...
                  <span className="ml-4">Upload Videos</span>
                </a>
              </li>
              <li className="relative px-6 py-3">
                <a
                ...
                >
                  ...
                  <span className="ml-4">Update Posts</span>
                </a>
              </li>
              <li className="relative px-6 py-3">
                <a
                ...
                >
                  ...
                  <span className="ml-4">Other Menus</span>
                </a>
              </li>
            </ul>
          </div>
            ...
            <ul>
              ...
              <li className="relative px-6 py-3">
                ...
                >
                  ...
                  <span className="ml-4">Add Posts</span>
                </a>
              </li>
              <li className="relative px-6 py-3">
                <a
