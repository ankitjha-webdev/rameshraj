...
//     errors.message = 'Must be 40 characters or more';
//   }
//   return errors;
// };
...
// https://getform.io/f/ee0ee0e0-ee0e-ee0e-ee0e-ee0ee0ee0ee
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      .required('Required'),
      phone: Yup.number()
      .min(10, 'At most 10 characters long')
      .required('Required'),
      message: Yup.string()
...
<section className="container mx-auto flex flex-col items-center px-12 py-28 sm:flex-row sm:px-12">
  <div className="container mx-auto">
    <div className="-mx-4 flex flex-wrap lg:justify-between">
      <div className="w-full px-4 lg:w-1/2 xl:w-6/12 animate-fade-right">
        <div className="mb-12 max-w-[570px] lg:mb-0">
          <span className="mb-4 block leading-relaxed text-slate-700 dark:text-slate-400">
            Contact Us
          </span>
          <h2
            className="mb-4 text-3xl font-bold leading-tight dark:text-slate-50 md:text-4xl"
          >
            GET IN TOUCH WITH ME
          </h2>
          <p className="leading-relaxed text-slate-700 dark:text-slate-400 mb-9">
          I am actively engaged in the preservation and protection of snakes. Our primary objective is to convey a significant message within our society pertaining to the rescue of snakes, addressing snake bites, and promoting the optimal health of all living creatures, all facilitated through the utilization of our <a className="text-blue-400 hover:text-blue-600 font-semibold" href="https://www.youtube.com/@snakerescuemuz" target="_blank" rel="noreferrer">YouTube channel</a> .
          </p>
          <p className="leading-relaxed text-slate-700 dark:text-slate-400 mb-9">
          My unwavering commitment lies in aiding the vulnerable members of our community and fostering the well-being of every living entity.
          </p>
          ...
          <div className="mb-8 flex w-full max-w-[370px]">
            ...
            <div className="w-full">
              ...
              {/* <p className="leading-relaxed text-slate-700 dark:text-slate-400">info@rameshraj.com</p> */}
              <p className="leading-relaxed text-slate-700 dark:text-slate-400">apnamuz@gmail.com</p>
            </div>
          </div>
        </div>
      </div>
      <div className="w-full  px-4 lg:w-1/2 xl:w-5/12 animate-fade-left" >
        <div className="rounded-lg bg-white p-8 shadow-lg sm:p-12">
          <form onSubmit={formik.handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="rounded-lg text-center justify-center items-center border-0 bg-blue-400 px-6 py-2 mx-2 text-base text-white shadow shadow-blue-300 transition     hover:bg-blue-500 hover:shadow-blue-400 dark:shadow-blue-900 w-full p-3 hover:bg-opacity-90"
              >
            {loading ? <><Loader/></> : 'Send Message'}    </button>
            </div>
          </form>
          {/* <div>
            <span className="relative -top-full -right-full z-[1]">
              <svg
                width="100"
                height="100"
                viewBox="0 0 100 100"
