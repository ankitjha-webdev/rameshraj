    ...
    <>
      ...
      <>
        ...
        <div className="mb-8 w-full sm:mb-0 sm:w-1/2 sm:pl-4 md:pl-16">
          <img
            alt="Profile"
            className="rounded-lg sm:rounded-br-[80px] sm:rounded-tl-[120px] animate-fade-right"
            src={profile}
          />
        </div>
          {/* <img
            ...
            src={profile}
          /> */}
          <div className="mr-4 w-full text-center sm:w-1/2 sm:text-left animate-fade-left">
