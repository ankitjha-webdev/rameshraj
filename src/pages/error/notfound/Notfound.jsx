...
export const Notfound = () => {
  ...
  <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
    <div className="max-w-md">
      ...
      <Link to="/about">
      <button type="button" className="rounded-lg border-0 mx-2 mt-8 bg-blue-400 px-6 py-2  text-base text-white shadow-lg shadow-blue-300 transition     hover:bg-blue-500 hover:shadow-blue-400 dark:shadow-blue-900">
        back to homepage
      </button>
      </Link>
    </div>
